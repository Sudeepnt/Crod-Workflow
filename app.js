const tables = [
  {
    ...
    title: "Ventures",
    singular: "Venture",
    summary: "Software companies, clients, and partners",
    listColumns: ["name", "type", "status", "verticals", "created_at"],
    fields: [
      { name: "name", label: "Name", type: "text", required: true },
      { name: "date", label: "Start date", type: "date" },
      { name: "type", label: "Type", type: "select", options: ["Internal Company", "Client", "Technology Partner", "Agency", "Vendor", "Investor", "Prospect"], required: true },
      { name: "status", label: "Status", type: "select", options: ["Prospect", "Onboarding", "Active", "Paused", "Archived"] },
      { name: "verticals", label: "Product focus", type: "text", placeholder: "Web apps, websites, AI, SaaS, APIs" },
      ...
      { name: "tags", label: "Tags", type: "text", placeholder: "Products, platforms, industries" },
    ],
  },
  {
    key: "people",
    ...
    fields: [
      ...
      { name: "type", label: "Type", type: "select", options: ["Founder", "Engineering", "Product", "Design", "QA", "Employee", "Client", "Partner", "Investor", "Contractor", "Vendor", "Consultant", "Freelancer"], required: true },
      { name: "role_title", label: "Role title", type: "text", placeholder: "Product Manager, Backend Engineer, UX Designer, QA Lead, ML Engineer" },
      { name: "status", label: "Status", type: "select", options: ["Active", "Inactive"], value: "Active" },
      { name: "access_level", label: "Access level", type: "select", options: ["Founder", "Admin", "Partner", "Employee", "Client", "Contractor"] },
    ],
  },
  {
    key: "projects",
    ...
    fields: [
      { name: "name", label: "Name", type: "text", required: true },
      { name: "venture", label: "Venture", type: "text" },
      { name: "vertical", label: "Product area", type: "text" },
      { name: "type", label: "Type", type: "select", options: ["Web Application", "Website", "AI Product", "SaaS Platform", "API / Backend", "Mobile App", "Internal Tool", "Prototype", "Client Delivery", "Strategy"] },
      { name: "asset", label: "Product / system", type: "text" },
      { name: "stage", label: "Stage", type: "select", options: ["Discovery", "Requirements", "Design", "Development", "QA", "Deployment", "Support", "Close"] },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "type", label: "Type", type: "select", options: ["Brief", "Product Requirements", "Technical Specification", "UX Research", "API Documentation", "Test Plan", "Feedback", "Proposal", "Agreement", "Release Notes", "Research", "Report", "Comms", "Roadmap"] },
  ...
  },
  {
    ...
    singular: "Asset",
    summary: "Codebases, designs, datasets, environments, releases, and source files",
    listColumns: ["name", "type", "status", "project", "created_at"],
    fields: [
      { name: "name", label: "Name", type: "text", required: true, placeholder: "Frontend App, API Service, AI Model, Design System" },
      { name: "project", label: "Project", type: "select", required: true },
      { name: "type", label: "Type", type: "select", options: ["Web App", "Website", "API", "Mobile App", "AI Model", "Dataset", "Design System", "Component", "Database", "Integration", "Deployment", "Source File", "Document", "Tool"], required: true },
      { name: "engine", label: "Stack / platform", type: "select", options: ["React", "Next.js", "Node.js", "Python", "FastAPI", "Django", "OpenAI", "PostgreSQL", "Supabase", "AWS", "Vercel", "Other"] },
      { name: "format", label: "Format", type: "select", options: ["GitHub", "Figma", "OpenAPI", "SQL", "JSON", "CSV", "PNG", "MP4", "PDF", "Docker", "Terraform", "Other"] },
      ...
      { name: "due_date", label: "Due date", type: "date" },
      { name: "permission", label: "Permission", type: "select", options: ["Internal", "Restricted", "Client-visible", "Contractor-visible"] },
      { name: "tags", label: "Tags", type: "text", placeholder: "frontend, API, AI, analytics, QA, deployment" },
    ],
  },
  {
    key: "events",
    ...
    fields: [
      ...
      { name: "project", label: "Project", type: "select" },
      { name: "task", label: "Task", type: "select" },
      { name: "type", label: "Type", type: "select", options: ["Meeting", "Call", "Review", "QA Session", "Demo", "Milestone", "Other"] },
      ...
      { name: "location", label: "Location", type: "select", options: ["Google Meet", "Zoom", "Microsoft Teams", "Office", "Client Site", "Other"] },
...
const data = {
  ventures: [
    {
      ...
      status: "Active",
      verticals: ["Web Apps", "AI Products", "SaaS"],
      date: "2026-06-28",
    ...
    },
    {
      ...
      status: "Active",
      verticals: ["Cloud Infrastructure", "Data Engineering"],
      date: "2026-06-28",
      entity_form: "LLP",
    },
    {
      ...
      type: "Client",
      status: "Onboarding",
      verticals: ["Web Platform", "Customer Experience", "Analytics"],
      date: "2026-06-28",
      entity_form: "Private Limited",
    },
  ],
  people: [
    {
      ...
      phone: "9000000001",
      venture: "Crod",
      role_title: "Founder / Product & Technology",
    ...
    },
    {
      ...
      phone: "9000000002",
      venture: "Crod",
      role_title: "Product Operations Lead",
    ...
    },
    {
      ...
      name: "Rhea Stone",
      type: "Partner",
      email: "rhea@northstar.systems",
      phone: "9000000006",
      venture: "Northstar Systems",
    ...
    },
    {
      ...
      name: "Leah Frost",
      type: "Client",
      email: "leah@brightline.ventures",
      phone: "9000000008",
      venture: "Brightline Ventures",
      role_title: "Client Product Lead",
      access_level: "Client",
      status: "Active",
    },
    {
      ...
      name: "Omar Vale",
      type: "Consultant",
      email: "omar@brightline.ventures",
      phone: "9000000009",
      venture: "Brightline Ventures",
      role_title: "AI Automation Consultant",
      access_level: "Client",
      status: "Active",
    },
  ],
  projects: [
    {
      id: "prj_1",
      name: "Crod Client Portal",
      venture: "Crod",
      vertical: "Web Application",
  ...
  tasks: [
    {
      id: "tsk_1",
      title: "Define portal auth and permissions",
      venture: "Crod",
      project: "Crod Client Portal",
      status: "To-Do",
      priority: "High",
      owner: "Aditya",
    ...
    {
      id: "tsk_2",
      title: "Polish onboarding dashboard flows",
      venture: "Crod",
      project: "Crod Client Portal",
      status: "In-Progress",
      priority: "Medium",
    ...
    {
      id: "tsk_3",
      title: "Review AI assistant response quality",
      venture: "Crod",
      project: "Crod AI Operations Hub",
      status: "Blocked",
      priority: "High",
      owner: "Utsav",
      due_date: "2026-07-08",
    ...
    {
      id: "tsk_4",
      title: "Prototype data ingestion pipeline",
      venture: "Northstar Systems",
      project: "Northstar Data Platform",
      status: "Backlog",
      priority: "Low",
      owner: "Jin Park",
      due_date: "2026-07-15",
    ...
    },
    {
      ...
      venture: "Crod",
      project: "Crod Client Portal",
      parent_task: "Define portal auth and permissions",
      status: "To-Do",
      priority: "Medium",
      owner: "Dev Menon",
      due_date: "2026-07-01",
    ...
    {
      id: "tsk_6",
      title: "Finalize API error handling",
      venture: "Crod",
      project: "Crod Client Portal",
      parent_task: "Define portal auth and permissions",
      status: "Backlog",
    ...
    {
      id: "tsk_7",
      title: "Tune AI prompt evaluation set",
      venture: "Crod",
      project: "Crod AI Operations Hub",
      parent_task: "Review AI assistant response quality",
      status: "In-Progress",
      priority: "Medium",
      owner: "Mira Sol",
      due_date: "2026-07-03",
    ...
    {
      id: "tsk_10",
      title: "Revise product demo flow",
      venture: "Crod",
      project: "Crod AI Operations Hub",
      parent_task: "Review AI assistant response quality",
      status: "To-Do",
  ...
  documents: [
    {
      id: "doc_1",
      title: "Crod product roadmap",
      date: "2026-06-28",
      venture: "Crod",
      type: "Brief",
      body: "Q3 roadmap covering web app delivery, AI automation, client onboarding, and platform reliability.",
      version: 1,
      status: "Draft",
      links: ["Crod"],
      permission: "Internal",
    ...
    {
      id: "doc_2",
      title: "Client portal delivery agreement",
      date: "2026-06-28",
      venture: "Crod",
      project: "Crod Client Portal",
      type: "Agreement",
      body: "Milestone alignment for the Crod Client Portal launch and support handover.",
      version: 1,
      status: "Final",
      links: ["Crod Client Portal"],
      permission: "Restricted",
      tags: ["seed"],
    },
    {
      id: "doc_3",
      title: "AI assistant review notes",
      date: "2026-06-28",
      venture: "Crod",
      project: "Crod AI Operations Hub",
      task: "Review AI assistant response quality",
      type: "Report",
      body: "Notes from the first client review round for assistant quality, workflows, and launch readiness.",
      version: 1,
      status: "Signed",
      links: ["Review AI assistant response quality"],
  ...
  events: [
    {
      ...
      summary: "Company-level planning for product priorities, delivery, and staffing.",
      calendar_ref: "cal-v1",
    },
    {
      id: "evt_2",
      ...
      summary: "Client call to review portal milestones, adoption, and launch positioning.",
      calendar_ref: "cal-p1",
    },
    {
      id: "evt_3",
      title: "AI product demo review",
      date: "2026-06-28",
      venture: "Crod",
      project: "Crod AI Operations Hub",
      task: "Review AI assistant response quality",
      ...
      location: "Office",
      summary: "Review assistant workflows, response quality, and the customer demo sequence.",
      calendar_ref: "cal-t1",
    },
  ],
  assets: [
    {
      ...
      version: "v3",
      status: "Approved",
      file_ref: "repo://crod-client-portal/frontend",
      owner: "Mira Sol",
      reviewer: "Aditya",
      due_date: "2026-07-05",
      permission: "Internal",
      tags: "frontend, portal, auth",
    },
    {
      id: "ast_2",
      ...
      version: "v5",
      status: "Approved",
      file_ref: "repo://crod-client-portal/api",
      owner: "Dev Menon",
      reviewer: "Sudeep N",
      due_date: "2026-07-08",
      permission: "Internal",
      tags: "api, integrations, permissions",
    },
    {
      id: "ast_3",
      name: "AI Assistant Evaluation Set",
      venture: "Crod",
      project: "Crod AI Operations Hub",
      type: "Dataset",
      engine: "OpenAI",
      ...
      version: "v2",
      status: "In-Review",
      file_ref: "drive://crod-ai/evaluation-set-v2.csv",
      owner: "Utsav",
      reviewer: "Omar Vale",
      due_date: "2026-07-06",
      permission: "Client-visible",
    ...
    {
      id: "ast_4",
      name: "Northstar Data Ingestion Service",
      venture: "Northstar Systems",
      project: "Northstar Data Platform",
      type: "Integration",
      engine: "Python",
      ...
      version: "v1",
      status: "Concept",
      file_ref: "repo://northstar-data/ingestion-service",
      owner: "Jin Park",
      reviewer: "Rhea Stone",
      due_date: "2026-07-14",
      permission: "Restricted",
      tags: "data, ingestion, cloud",
    },
    {
      id: "ast_5",
      name: "Client Product Roadmap",
      venture: "Brightline Ventures",
      project: "Crod Client Portal",
      type: "Document",
      engine: "Other",
      ...
      version: "v4",
      status: "Delivered",
      file_ref: "drive://brightline/client-portal-roadmap-v4.pdf",
      owner: "Leah Frost",
      reviewer: "Sudeep N",
      due_date: "2026-07-03",
      permission: "Client-visible",
      tags: "roadmap, client, delivery",
    },
  ],
  transactions: [
    {
...
const peopleTypeHierarchy = ["Founder", "Engineering", "Product", "Design", "QA", "Partner", "Client", "Vendor", "Consultant", "Contractor", "Employee"];
